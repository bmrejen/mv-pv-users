export class Keys {
    ...
    public static getApiKey() {
        return "AIzaSyBeysOdY1ZjiSNpj-PA5Qr2Z-EaJGQNOTQ";
    }

    public static getClientId() {
        return "370957812504-q434e61j772ehv68fl4722fraomiduc4.apps.googleusercontent.com";
    }

    public static getIss() {
        return "service-account-1@user-interface-1007.iam.gserviceaccount.com";
    }
    ...
    public static getJamespotModuleName() {
        return "EXT-MV-User-Admin";
    }

    public static getJamespotModuleKey() {
        return "dAl4fQm52s";
    }
}
