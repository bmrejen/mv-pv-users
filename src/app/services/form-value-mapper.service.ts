...
export class FormValueMapperService {
    ...
    public createUserForSugar(createForm: NgForm) {
        ...
        // const firstName = form.userInfo.credentials.firstname;
        // const lastName = form.userInfo.credentials.lastname;
        // const userName = form.userInfo.credentials.username;
        // const email = form.userInfo.credentials.email;
